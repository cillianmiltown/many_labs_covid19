...
g <- ggplot(df1, aes(moral_identity_internal, policy_support_tot, linetype =political_ideology_3groups))+
  ...
  labs(y = "Policy Support",
       x = "Moral Identity Internalization",
...
Figure \@ref(fig:policyMIsymbolicNZLUSA1) shows the relationship between Political Ideology and Symbolic Moral Identity in predicting Policy Support for the New Zealand sample and the USA sample separately.

```{r policyMIsymbolicNZLUSA1, fig.cap="USA: Interaction between Political Ideology and Internal Moral Identity in predicting Policy Support", include=TRUE, message=FALSE, fig.height=3}
df1 <- df[which(df$country=="USA"|df$country=="NZL"),]
g <- ggplot(df1, aes(moral_identity_symbolic, policy_support_tot, linetype =political_ideology_3groups))+
  geom_jitter(height = .1, width = .1, size=.0001, color="gray") + 
  #ylim(0,12) +
  geom_smooth(method=lm, size = .5, color="black") +
  labs(y = "Policy Support",
       x = "Moral Identity Symbolization",
       linetype = "Political Ideology"
       )+
  theme_apa()+
  scale_linetype_manual(values = c("longdash", "solid", "dotted"),
...
Figure \@ref(fig:contactMIsymbolicNZLUSA1) shows the relationship between Political Ideology and Symbolic Moral Identity in predicting Physical contact for the New Zealand sample and the USA sample separately.

```{r contactMIsymbolicNZLUSA1, fig.cap="USA: Interaction between Political Ideology and Internal Moral Identity in predicting Policy Support", include=TRUE, message=FALSE, fig.height=3}
df1 <- df[which(df$country=="USA"|df$country=="NZL"),]
g <- ggplot(df1, aes(moral_identity_symbolic, physical_contact_tot, linetype =political_ideology_3groups))+
  geom_jitter(height = .1, width = .1, size=.0001, color="gray") + 
  #ylim(0,12) +
  geom_smooth(method=lm, size = .5, color="black") +
  labs(y = "Physical Contact",
...
Figure \@ref(fig:hygieneMIsymbolicNZLUSA1) shows the relationship between Political Ideology and Symbolic Moral Identity in predicting Physical Hygiene for the New Zealand sample and the USA sample separately.

```{r hygieneMIsymbolicNZLUSA1, fig.cap="USA: Interaction between Political Ideology and Internal Moral Identity in predicting Policy Support", include=TRUE, message=FALSE, fig.height=3}
df1 <- df[which(df$country=="USA"|df$country=="NZL"),]
g <- ggplot(df1, aes(moral_identity_symbolic, physical_hygiene_tot, linetype =political_ideology_3groups))+
  geom_jitter(height = .1, width = .1, size=.0001, color="gray") + 
  #ylim(0,12) +
  geom_smooth(method=lm, size = .5, color="black") +
  labs(y = "Physical Hygiene",
